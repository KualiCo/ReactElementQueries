...
/***/ function(module, exports, __webpack_require__) {
	...
	var ElementQueryMixin = __webpack_require__(1);
	...
	var App = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(ElementQueryDemo, null)
	    );
	  }
	});
	...
	var ElementQueryDemo = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(ElementQueryStyleDemo, null),
	      React.createElement(ElementQueryTableDemo, null),
	      React.createElement(ElementQueryCardDemo, null)
	    );
	  }
	});

	var ElementQueryStyleDemo = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "p",
	        null,
	        "Colors change ever 200px below 900px"
	      ),
	      React.createElement(ColorBar, null),
	      React.createElement(
	        "p",
	        null,
	        "Color bar in 400px container"
	      ),
	      React.createElement(
	        "div",
	        { style: { width: 400 } },
	...
	var ColorBar = React.createClass({
	  ...
	  getEqPoints: function getEqPoints() {
	    return {
	      blue: 900,
	      red: 700,
	      green: 500,
	...
	var ElementQueryTableDemo = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "p",
	        null,
	        "Break point at 900px"
	      ),
	      this.state.eqState == "table" && React.createElement(
	        "table",
	        { className: "table" },
	        React.createElement(
	          "thead",
	...
	var ElementQueryCardDemo = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "p",
	        null,
	        "Large image appears when card is wider than 400px and taller than 200px"
	      ),
	      React.createElement(
	        "div",
	        { style: { width: "50%", height: "400px", marginBottom: 10 } },
	        React.createElement(KittyCard, null)
	      ),
	      React.createElement(
	        "div",
	        { style: { width: "200px" } },
	...
	var KittyCard = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      "div",
	      { style: { height: "100%" }, className: "card primary" },
	      this.state.eqWState == "full" && this.state.eqHState == "full" && React.createElement("img", { style: { width: "100%" }, src: "http://placekitten.com/g/400/200" }),
	      React.createElement(
	        "div",
	        { className: "card-divider" },
	        (this.state.eqWState != "full" || this.state.eqHState != "full") && React.createElement("img", { style: { width: 25, height: 15, marginRight: 10 }, src: "http://placekitten.com/g/400/200" }),
	        "I'm so cute!"
	      ),
	      React.createElement(
	        "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  getNormalizedEqPoints: function getNormalizedEqPoints() {
	    var eqPts = this.getEqPoints ? this.getEqPoints() : null;
	    if (!eqPts) {
	      return null;
	    }
	  ...
	  runEqQueries: function runEqQueries() {
	    var getActiveState = function (points, currentValue) {
	      var sortedKeys = Object.keys(points).sort(function (a, b) {
	        return points[b] - points[a];
	      });

	      var currentState = "";
	      for (var j = 0; j < sortedKeys.length; j++) {
	        var eqState = sortedKeys[j];
	        var pointValue = points[eqState];
	    ...
	    var _getNormalizedEqPoints = this.getNormalizedEqPoints();

	    var _getNormalizedEqPoints2 = _slicedToArray(_getNormalizedEqPoints, 2);

	    var eqWPts = _getNormalizedEqPoints2[0];
	    var eqHPts = _getNormalizedEqPoints2[1];

	    var updatedState = {};
	    if (eqWPts) {
	      var eqState = getActiveState(eqWPts, this.getDOMNode().offsetWidth);
	      updatedState.eqState = eqState;
	      updatedState.eqWState = eqState;
	    }
	    if (eqHPts) {
	      var eqState = getActiveState(eqHPts, this.getDOMNode().offsetHeight);
